...
" from https://github.com/blueshirts/darcula/blob/master/colors/darcula.vim
" MIT-licensed
"
...
let g:colors_name = "darcula_myd0t"

" PuTTY is behaving weirdly when setting the bg color on TERM=xterm and shows
" the empty space at the end of non-empty lines in the normal (black) background,
" so we stick with all-black there
let darculabg = &term =~ '^\(tmux\|screen\)' ? 234 : 'black'
...
exe 'hi Folded ctermfg=244 ctermbg='.darculabg.' cterm=NONE guifg=#8e9292 guibg=#2b2b2b gui=NONE'

exe 'hi Normal ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
...
exe 'hi NonText ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#888888 guibg=#2b2b2b gui=NONE'
...
exe 'hi yamlDocumentHeader ctermfg=NONE ctermbg='.darculabg.' cterm=NONE guifg=NONE guibg=#292929 gui=NONE'
...
exe 'hi jsParen ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
...
exe 'hi jsonBraces ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'

" Extra CoffeeScript highlighting.
exe 'hi coffeeObject ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
hi coffeeObjAssign ctermfg=222 ctermbg=NONE cterm=NONE guifg=#d9c767 guibg=NONE gui=NONE
exe 'hi coffeeSpecialVar ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
...
exe 'hi vimParenSep ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
exe 'hi vimVar ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
hi vimFuncName ctermfg=103 ctermbg=NONE cterm=NONE guifg=#a9b7c6 guibg=NONE gui=NONE
exe 'hi vimIsCommand ctermfg=188 ctermbg='.darculabg.' cterm=NONE guifg=#a9b7c6 guibg=#2b2b2b gui=NONE'
